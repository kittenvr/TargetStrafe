...
import com.example.addon.util.Interactions;
import com.example.addon.util.RotationHelper;
...
public class TargetStrafe extends Module {
    ...
    public TargetStrafe() {
        super(Addon.CATEGORY, "target-strafe", "automatically circle your target");
    }
